...
@Autonomous(name = "AutoRedTopEn")
public class AutoRedTopEn extends LinearOpMode {
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        while (robot.frontLeft.getCurrentPosition() > -3*rev/2 && robot.frontRight.getCurrentPosition() > -3*rev/2 && robot.backLeft.getCurrentPosition() > -3*rev/2 && robot.backRight.getCurrentPosition() > -3*rev/2) {
        }
