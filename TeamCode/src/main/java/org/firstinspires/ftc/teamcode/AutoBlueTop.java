...
//-------------------------------------------------------qqqq-----------------------------------------------------------------------
        ...
        while(robot.ods_sensor_front.getVoltage() > 0.048) {
        ...
        if(cryptobox_column == "LEFT") {
            while (robot.ods_sensor_back.getVoltage() > 0.81) {
                telemetry.addData("Distance", robot.ods_sensor_front.getVoltage());
                telemetry.update();
            }
        } else if(cryptobox_column == "CENTER") {
            while (robot.ods_sensor_front.getVoltage() < 0.06) {
                telemetry.addData("Distance", robot.ods_sensor_front.getVoltage());
                telemetry.update();
            }
        } else {
            while (robot.ods_sensor_front.getVoltage() < 0.09) {
